...
class BaseResponse:
    ...
    def success_response(
        message: str = "API success", status_code: int = status.HTTP_200_OK, message_code: int = 0, data=None
    ):
        ...
        """
        return JSONResponse(
            status_code=status_code, content={"message_code": message_code, "message": message, "data": data}
        )
